...
arrowfunction("Erion Mehmeti");

function name(){
    var localvar="Erion";   //Variabla lokale
    alert(localvar);
}
name();
...
var computer2=new Computer("HP","Core i5", "4GB", "Integrated");
...
document.write("<br>Computer 2:"+ computer.name+", "+computer2.CPU+", "+computer2.RAM+", "+computer2.GPU);
